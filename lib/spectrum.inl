...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_FREQUENCIES = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_WHITE = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_CYAN = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_MAGENTA = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_YELLOW = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_RED = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_GREEN = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_REFL_BLUE = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_WHITE = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_CYAN = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_MAGENTA = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_YELLOW = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_RED = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_GREEN = {
...
constexpr std::array<float, RGB_NUM_SAMPLES> RGB_ILLUM_BLUE = {
